...
clear @s diamond_sword{ma1sword:4}

##Give the user 1 diamond sword
give @s diamond_sword{Unbreakable:1b,noDrop:1,ma1sword:5,Enchantments:[{id:"minecraft:sharpness",lvl:4s}]} 1
...
tellraw @s ["",{"text":"[Mob Arena] ","bold":true,"color":"green"},{"text":"Purchased ","color":"green"},{"text":"Sharpness 4","color":"gold"},{"text":" for ","color":"green"},{"text":"6 XP Levels","color":"dark_green"},{"text":"!","color":"green"}]
