...
tellraw @a[team=MA1] ["",{"text":"[Mob Arena] ","bold":true,"color":"green"},{"text":"5 Zombies! ","color":"dark_green"},{"text":"have spawned!","color":"green"}]
#Informs MA1 spectators that 5 zombies have spawned
tellraw @a[team=MA1Spectate] ["",{"text":"[Mob Arena] ","bold":true,"color":"green"},{"text":"5 Zombies! ","color":"dark_green"},{"text":"have spawned!","color":"green"}]
